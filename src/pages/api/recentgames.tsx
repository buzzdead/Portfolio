...
export default async function handler(
  ...
  const recentGamesSummaries: RecentGameSummary[] = steam.response.games?.filter((e: any) => e.appid !== 250820 && e.appid !== 719950 && e.appid !== 1408230 && e.appid !== 730 && e.appid !== 685110 && e.appid !== 684380)
  return res.status(200).json(
